        ...
        <header className="flex flex-col md:flex-row md:items-end justify-between gap-6">
          <div className="space-y-4">
            <div className="flex items-center gap-3">
               ...
               <span className="text-[10px] font-bold uppercase tracking-[4px] text-slate-400">Professional Assessment Suite</span>
            </div>
          ...
          <div className="flex gap-4">
             <div className="bg-white px-8 py-5 rounded-3xl border border-slate-200 shadow-sm flex flex-col items-center justify-center min-w-[150px]">
             ...
             <div className="bg-[#0F172A] px-8 py-5 rounded-3xl shadow-xl flex flex-col items-center justify-center min-w-[150px] text-white">
                <span className="text-3xl font-black text-indigo-400">99.8%</span>
                <span className="text-[9px] font-bold text-slate-400 uppercase tracking-widest">Precision Index</span>
             </div>
          </div>
        </header>
        ...
        <section className="space-y-6">
          ...
          {loading ? (
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
               <div className="bg-white p-12 rounded-[2.5rem] border border-slate-200 flex flex-col items-center justify-center text-center space-y-6 shadow-sm">
                  <div className="size-16 bg-slate-50 rounded-2xl flex items-center justify-center text-slate-300">
                    <AlertCircle size={32} />
                  </div>
                  <div className="space-y-2">
                    <h3 className="text-lg font-bold uppercase">No Active Channels</h3>
                  ...
                  className="px-8 py-3.5 bg-[#0F172A] text-white rounded-xl font-bold uppercase text-[10px] tracking-widest hover:bg-slate-800 transition-all"
                  >
                    Browse Internships
                  </button>
               </div>

               <div className="bg-indigo-600 p-12 rounded-[2.5rem] text-white flex flex-col items-center justify-center text-center space-y-6 shadow-xl relative overflow-hidden group">
                  ...
                  <div className="space-y-2 relative z-10">
                    <h3 className="text-lg font-bold uppercase">General Practice</h3>
                    <p className="text-indigo-100/70 text-sm font-medium max-w-xs mx-auto">Ready to sharpen your skills? Start a general technical assessment right now.</p>
                  </div>
                  <button 
                    onClick={() => router.push('/dashboard/interview/general')}
                    className="px-10 py-4 bg-white text-indigo-600 rounded-xl font-bold uppercase text-[10px] tracking-widest hover:scale-105 transition-all shadow-lg"
                  >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
               {applications.map((app, i) => (
                 <motion.div 
                   ...
                   className="bg-white p-8 rounded-[2rem] border border-slate-200 shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all group overflow-hidden relative"
                 >
                    ...
                    <div className="flex flex-col gap-3">
                       <button 
                        ...
                        className="w-full py-4 bg-[#0F172A] text-white rounded-xl font-bold uppercase text-[10px] tracking-widest flex items-center justify-center gap-2 hover:bg-indigo-600 transition-colors shadow-md"
                       >
                         Begin Session <Play size={12} className="fill-white" />
                       </button>
                    </div>
                 </motion.div>
               ))}
